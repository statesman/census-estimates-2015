...
def getCounties():
    ...
    """
    with open("CO-EST2015-alldata.csv", "rb") as infile, open("us_county_pop_2015.csv", "wb") as usfile, open("tx_county_pop_2015.csv", "wb") as txfile, open("state_county_pop_2015_tmp.csv", "wb") as statefile:
        headers = [
            "statefips",
            "countyfips",
            "state",
